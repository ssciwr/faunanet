...
You can also change the model on the fly via the `change_analyzer` command. This command functions almost identically to the `start` command. See the documentation of the REPL {doc}`repl_usage` for more.
